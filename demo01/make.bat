...
%HLSL% /D TRIANGLE_VS /E TriangleVs /Fo data\triangle.vso /T vs_5_1 triangle.hlsl & if errorlevel 1 goto :end
%HLSL% /D TRIANGLE_PS /E TrianglePs /Fo data\triangle.pso /T ps_5_1 triangle.hlsl & if errorlevel 1 goto :end
