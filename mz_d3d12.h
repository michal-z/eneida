...
typedef struct ID3D12GraphicsCommandList_vtable {
    ...
    void(__stdcall *CopyTiles)(ID3D12GraphicsCommandList *self, ID3D12Resource *tiled_resource,
                               ...
                               ID3D12Resource *buffer, u64 buffer_start_offset_in_bytes,
                               D3D12_TILE_COPY_FLAGS flags);
    void(__stdcall *ResolveSubresource)(ID3D12GraphicsCommandList *self,
                                        ID3D12Resource *dst_resource, u32 dst_subresource,
                                        ID3D12Resource *src_resource, u32 src_subresource,
                                        DXGI_FORMAT format);
    ...
    void(__stdcall *ExecuteIndirect)(ID3D12GraphicsCommandList *self,
                                     ...
                                     u32 max_command_count, ID3D12Resource *argument_buffer,
                                     u64 argument_buffer_offset, ID3D12Resource *count_buffer,
...
typedef struct ID3D12Device_vtable {
    ...
    void(__stdcall *CopyDescriptors)(
        ...
        const u32 *src_descriptor_range_sizes, D3D12_DESCRIPTOR_HEAP_TYPE descriptor_heaps_type);
...
typedef struct IDXGIFactory4_vtable {
    ...
    i32(__stdcall *CreateSwapChain)(IDXGIFactory4 *self, IUnknown *device,
                                    DXGI_SWAP_CHAIN_DESC *desc, IDXGISwapChain **out_swap_chain);
    ...
    i32(__stdcall *CreateSwapChainForCoreWindow)(IDXGIFactory4 *self, IUnknown *device,
                                                 ...
                                                 IDXGIOutput *restrict_to_output,
                                                 IDXGISwapChain1 **out_swap_chain);
    i32(__stdcall *GetSharedResourceAdapterLuid)(IDXGIFactory4 *self, void *resource,
                                                 i64 *out_luid);
