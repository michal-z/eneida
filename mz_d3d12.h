...
typedef i32(__stdcall *CreateDXGIFactory1_t)(const GUID *guid,
                                             void **out_object);

typedef i32(__stdcall *D3D12CreateDevice_t)(IUnknown *adapter,
                                            D3D_FEATURE_LEVEL min_feature_level,
                                            const GUID *guid,
                                            void **out_object);
typedef i32(__stdcall *D3D12GetDebugInterface_t)(const GUID *guid,
                                                 void **out_object);
...
#define D3D12_ENCODE_SHADER_4_COMPONENT_MAPPING(Src0, Src1, Src2, Src3)        \
  (((Src0)&0x7) | (((Src1)&0x7) << 3) | (((Src2)&0x7) << (3 * 2)) |            \
   (((Src3)&0x7) << (3 * 3)) | (1 << (3 * 4)))
...
#define D3D12_ENCODE_BASIC_FILTER(min, mag, mip, reduction)                    \
  ((D3D12_FILTER)((((min)&0x3) << 4) | (((mag)&0x3) << 2) | ((mip)&0x3) |      \
                  (((reduction)&0x3) << 7)))
#define D3D12_ENCODE_ANISOTROPIC_FILTER(reduction)                             \
  ((D3D12_FILTER)(0x40 | D3D12_ENCODE_BASIC_FILTER(D3D12_FILTER_TYPE_LINEAR,   \
                                                   D3D12_FILTER_TYPE_LINEAR,   \
                                                   D3D12_FILTER_TYPE_LINEAR,   \
                                                   reduction)))
#define D3D12_DECODE_MIN_FILTER(D3D12Filter)                                   \
  ((D3D12_FILTER_TYPE)(((D3D12Filter) >> 4) & 0x3))
#define D3D12_DECODE_MAG_FILTER(D3D12Filter)                                   \
  ((D3D12_FILTER_TYPE)(((D3D12Filter) >> 2) & 0x3))
#define D3D12_DECODE_MIP_FILTER(D3D12Filter)                                   \
  ((D3D12_FILTER_TYPE)(((D3D12Filter) >> 0) & 0x3))
...
typedef struct IUnknown_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(IUnknown *self, const GUID *guid,
                                 void **out_object);
...
#define IUnknown_QueryInterface(self, ...)                                     \
...
typedef struct ID3DBlob_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3DBlob *self, const GUID *guid,
                                 void **out_object);
...
#define ID3DBlob_QueryInterface(self, ...)                                     \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3DBlob_GetBufferPointer(self, ...)                                   \
  ((self)->vtbl->GetBufferPointer(self, __VA_ARGS__))
#define ID3DBlob_GetBufferSize(self, ...)                                      \
  ((self)->vtbl->GetBufferSize(self, __VA_ARGS__))

// ID3D12Object
typedef struct ID3D12Object_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12Object *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12Object *self);
  u32(__stdcall *Release)(ID3D12Object *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12Object *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12Object *self, const GUID *guid,
                                 u32 data_size, const void *data);
...
#define ID3D12Object_QueryInterface(self, ...)                                 \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12Object_AddRef(self, ...) ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12Object_Release(self, ...)                                        \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define ID3D12Object_GetPrivateData(self, ...)                                 \
  ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12Object_SetPrivateData(self, ...)                                 \
...
#define ID3D12Object_SetName(self, ...)                                        \
  ((self)->vtbl->SetName(self, __VA_ARGS__))

// ID3D12DeviceChild
typedef struct ID3D12DeviceChild_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12DeviceChild *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12DeviceChild *self);
  u32(__stdcall *Release)(ID3D12DeviceChild *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12DeviceChild *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12DeviceChild *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12DeviceChild *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12DeviceChild *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12DeviceChild *self, const GUID *guid,
                            void **out_device);
...
#define ID3D12DeviceChild_QueryInterface(self, ...)                            \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12DeviceChild_AddRef(self, ...)                                    \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12DeviceChild_Release(self, ...)                                   \
  ((self)->vtbl->Release(self, __VA_ARGS__))
...
#define ID3D12DeviceChild_SetPrivateDataInterface(self, ...)                   \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12DeviceChild_SetName(self, ...)                                   \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12DeviceChild_GetDevice(self, ...)                                 \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))

// ID3D12RootSignature
typedef struct ID3D12RootSignature_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12RootSignature *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12RootSignature *self);
  u32(__stdcall *Release)(ID3D12RootSignature *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12RootSignature *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12RootSignature *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12RootSignature *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12RootSignature *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12RootSignature *self, const GUID *guid,
                            void **out_device);
...
#define ID3D12RootSignature_QueryInterface(self, ...)                          \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12RootSignature_AddRef(self, ...)                                  \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12RootSignature_Release(self, ...)                                 \
  ((self)->vtbl->Release(self, __VA_ARGS__))
...
#define ID3D12RootSignature_SetPrivateDataInterface(self, ...)                 \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12RootSignature_SetName(self, ...)                                 \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12RootSignature_GetDevice(self, ...)                               \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))

// ID3D12Pageable
typedef struct ID3D12Pageable_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12Pageable *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12Pageable *self);
  u32(__stdcall *Release)(ID3D12Pageable *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12Pageable *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12Pageable *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12Pageable *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12Pageable *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12Pageable *self, const GUID *guid,
                            void **out_device);
...
#define ID3D12Pageable_QueryInterface(self, ...)                               \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12Pageable_AddRef(self, ...)                                       \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12Pageable_Release(self, ...)                                      \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define ID3D12Pageable_GetPrivateData(self, ...)                               \
  ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12Pageable_SetPrivateData(self, ...)                               \
  ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12Pageable_SetPrivateDataInterface(self, ...)                      \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12Pageable_SetName(self, ...)                                      \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12Pageable_GetDevice(self, ...)                                    \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))

// ID3D12Heap
typedef struct ID3D12Heap_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12Heap *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12Heap *self);
  u32(__stdcall *Release)(ID3D12Heap *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12Heap *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12Heap *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12Heap *self, const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12Heap *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12Heap *self, const GUID *guid,
                            void **out_device);
  // ID3D12Pageable
  // ID3D12Heap
  D3D12_HEAP_DESC *(__stdcall *GetDesc)(ID3D12Heap *self,
                                        D3D12_HEAP_DESC *out_heap_desc);
} ID3D12Heap_vtable;
...
#define ID3D12Heap_QueryInterface(self, ...)                                   \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
typedef struct ID3D12Resource_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12Resource *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12Resource *self);
  u32(__stdcall *Release)(ID3D12Resource *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12Resource *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12Resource *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12Resource *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12Resource *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12Resource *self, const GUID *guid,
                            void **out_device);
  // ID3D12Pageable
  // ID3D12Resource
  i32(__stdcall *Map)(ID3D12Resource *self, u32 subresource,
                      const D3D12_RANGE *read_range, void **out_data);
  void(__stdcall *Unmap)(ID3D12Resource *self, u32 subresource,
                         const D3D12_RANGE *written_range);
  D3D12_RESOURCE_DESC *(__stdcall *GetDesc)(
      ID3D12Resource *self, D3D12_RESOURCE_DESC *out_resource_desc);
  ...
  i32(__stdcall *WriteToSubresource)(ID3D12Resource *self, u32 dst_subresource,
                                     ...
                                     const void *src_data, u32 src_row_pitch,
                                     u32 src_depth_pitch);
  i32(__stdcall *ReadFromSubresource)(ID3D12Resource *self, void *dst_data,
                                      u32 dst_row_pitch, u32 dst_depth_pitch,
                                      u32 src_subresource,
                                      const D3D12_BOX *src_box);
  i32(__stdcall *GetHeapProperties)(ID3D12Resource *self,
                                    D3D12_HEAP_PROPERTIES *out_properties,
...
#define ID3D12Resource_QueryInterface(self, ...)                               \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12Resource_AddRef(self, ...)                                       \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12Resource_Release(self, ...)                                      \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define ID3D12Resource_GetPrivateData(self, ...)                               \
  ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12Resource_SetPrivateData(self, ...)                               \
  ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12Resource_SetPrivateDataInterface(self, ...)                      \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12Resource_SetName(self, ...)                                      \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12Resource_GetDevice(self, ...)                                    \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
...
#define ID3D12Resource_GetDesc(self, ...)                                      \
  ((self)->vtbl->GetDesc(self, __VA_ARGS__))
...
typedef struct ID3D12CommandAllocator_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12CommandAllocator *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12CommandAllocator *self);
  u32(__stdcall *Release)(ID3D12CommandAllocator *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12CommandAllocator *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12CommandAllocator *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12CommandAllocator *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12CommandAllocator *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12CommandAllocator *self, const GUID *guid,
                            void **out_device);
  // ID3D12Pageable
  // ID3D12CommandAllocator
...
#define ID3D12CommandAllocator_QueryInterface(self, ...)                       \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12CommandAllocator_AddRef(self, ...)                               \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12CommandAllocator_Release(self, ...)                              \
  ((self)->vtbl->Release(self, __VA_ARGS__))
...
#define ID3D12CommandAllocator_SetPrivateDataInterface(self, ...)              \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12CommandAllocator_SetName(self, ...)                              \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12CommandAllocator_GetDevice(self, ...)                            \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
#define ID3D12CommandAllocator_Reset(self, ...)                                \
  ((self)->vtbl->Reset(self, __VA_ARGS__))

// ID3D12Fence
typedef struct ID3D12Fence_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12Fence *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12Fence *self);
  u32(__stdcall *Release)(ID3D12Fence *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12Fence *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12Fence *self, const GUID *guid,
                                 u32 data_size, const void *data);
  ...
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12Fence *self, const GUID *guid,
                            void **out_device);
  // ID3D12Pageable
  // ID3D12Fence
  u64(__stdcall *GetCompletedValue)(ID3D12Fence *self);
  i32(__stdcall *SetEventOnCompletion)(ID3D12Fence *self, u64 value,
                                       void *event);
...
#define ID3D12Fence_QueryInterface(self, ...)                                  \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12Fence_AddRef(self, ...) ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12Fence_Release(self, ...)                                         \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define ID3D12Fence_GetPrivateData(self, ...)                                  \
  ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12Fence_SetPrivateData(self, ...)                                  \
  ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12Fence_SetPrivateDataInterface(self, ...)                         \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12Fence_SetName(self, ...)                                         \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12Fence_GetDevice(self, ...)                                       \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
...
typedef struct ID3D12PipelineState_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12PipelineState *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12PipelineState *self);
  u32(__stdcall *Release)(ID3D12PipelineState *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12PipelineState *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12PipelineState *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12PipelineState *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12PipelineState *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12PipelineState *self, const GUID *guid,
                            void **out_device);
  // ID3D12Pageable
  // ID3D12PipelineState
...
#define ID3D12PipelineState_QueryInterface(self, ...)                          \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12PipelineState_AddRef(self, ...)                                  \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12PipelineState_Release(self, ...)                                 \
  ((self)->vtbl->Release(self, __VA_ARGS__))
...
#define ID3D12PipelineState_SetPrivateDataInterface(self, ...)                 \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12PipelineState_SetName(self, ...)                                 \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12PipelineState_GetDevice(self, ...)                               \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
...
typedef struct ID3D12DescriptorHeap_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12DescriptorHeap *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12DescriptorHeap *self);
  u32(__stdcall *Release)(ID3D12DescriptorHeap *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12DescriptorHeap *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12DescriptorHeap *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12DescriptorHeap *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12DescriptorHeap *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12DescriptorHeap *self, const GUID *guid,
                            void **out_device);
  // ID3D12Pageable
  // ID3D12DescriptorHeap
  D3D12_DESCRIPTOR_HEAP_DESC *(__stdcall *GetDesc)(
      ID3D12DescriptorHeap *self, D3D12_DESCRIPTOR_HEAP_DESC *out_desc);
...
#define ID3D12DescriptorHeap_QueryInterface(self, ...)                         \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12DescriptorHeap_AddRef(self, ...)                                 \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12DescriptorHeap_Release(self, ...)                                \
  ((self)->vtbl->Release(self, __VA_ARGS__))
...
#define ID3D12DescriptorHeap_SetPrivateDataInterface(self, ...)                \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12DescriptorHeap_SetName(self, ...)                                \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12DescriptorHeap_GetDevice(self, ...)                              \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
#define ID3D12DescriptorHeap_GetDesc(self, ...)                                \
  ((self)->vtbl->GetDesc(self, __VA_ARGS__))
...
typedef struct ID3D12QueryHeap_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12QueryHeap *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12QueryHeap *self);
  u32(__stdcall *Release)(ID3D12QueryHeap *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12QueryHeap *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12QueryHeap *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12QueryHeap *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12QueryHeap *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12QueryHeap *self, const GUID *guid,
                            void **out_device);
  // ID3D12Pageable
  // ID3D12QueryHeap
...
#define ID3D12QueryHeap_QueryInterface(self, ...)                              \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12QueryHeap_AddRef(self, ...)                                      \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12QueryHeap_Release(self, ...)                                     \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define ID3D12QueryHeap_GetPrivateData(self, ...)                              \
  ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12QueryHeap_SetPrivateData(self, ...)                              \
  ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12QueryHeap_SetPrivateDataInterface(self, ...)                     \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12QueryHeap_SetName(self, ...)                                     \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12QueryHeap_GetDevice(self, ...)                                   \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))

// ID3D12CommandSignature
typedef struct ID3D12CommandSignature_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12CommandSignature *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12CommandSignature *self);
  u32(__stdcall *Release)(ID3D12CommandSignature *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12CommandSignature *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12CommandSignature *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12CommandSignature *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12CommandSignature *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12CommandSignature *self, const GUID *guid,
                            void **out_device);
  // ID3D12Pageable
  // ID3D12CommandSignature
...
#define ID3D12CommandSignature_QueryInterface(self, ...)                       \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12CommandSignature_AddRef(self, ...)                               \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12CommandSignature_Release(self, ...)                              \
  ((self)->vtbl->Release(self, __VA_ARGS__))
...
#define ID3D12CommandSignature_SetPrivateDataInterface(self, ...)              \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12CommandSignature_SetName(self, ...)                              \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12CommandSignature_GetDevice(self, ...)                            \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))

// ID3D12CommandList
typedef struct ID3D12CommandList_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12CommandList *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12CommandList *self);
  u32(__stdcall *Release)(ID3D12CommandList *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12CommandList *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12CommandList *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12CommandList *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12CommandList *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12CommandList *self, const GUID *guid,
                            void **out_device);
  // ID3D12CommandList
...
#define ID3D12CommandList_QueryInterface(self, ...)                            \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12CommandList_AddRef(self, ...)                                    \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12CommandList_Release(self, ...)                                   \
  ((self)->vtbl->Release(self, __VA_ARGS__))
...
#define ID3D12CommandList_SetPrivateDataInterface(self, ...)                   \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12CommandList_SetName(self, ...)                                   \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12CommandList_GetDevice(self, ...)                                 \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
#define ID3D12CommandList_GetType(self, ...)                                   \
  ((self)->vtbl->GetType(self, __VA_ARGS__))

// ID3D12GraphicsCommandList
typedef struct ID3D12GraphicsCommandList_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12GraphicsCommandList *self,
  ...
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12GraphicsCommandList *self,
                                 const GUID *guid, u32 *out_data_size,
                                 void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12GraphicsCommandList *self,
                                 const GUID *guid, u32 data_size,
                                 const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12GraphicsCommandList *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12GraphicsCommandList *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12GraphicsCommandList *self, const GUID *guid,
                            void **out_device);
  // ID3D12CommandList
  ...
  i32(__stdcall *Reset)(ID3D12GraphicsCommandList *self,
                        ID3D12CommandAllocator *allocator,
                        ID3D12PipelineState *initial_state);
  void(__stdcall *ClearState)(ID3D12GraphicsCommandList *self,
                              ID3D12PipelineState *pipeline_state);
  void(__stdcall *DrawInstanced)(ID3D12GraphicsCommandList *self,
  ...
  void(__stdcall *DrawIndexedInstanced)(ID3D12GraphicsCommandList *self,
                                        ...
                                        u32 start_instance_location);
  void(__stdcall *Dispatch)(ID3D12GraphicsCommandList *self,
                            u32 thread_group_count_x, u32 thread_group_count_y,
                            u32 thread_group_count_z);
  void(__stdcall *CopyBufferRegion)(ID3D12GraphicsCommandList *self,
                                    ID3D12Resource *dst_buffer, u64 dst_offset,
                                    ID3D12Resource *src_buffer, u64 src_offset,
                                    u64 num_bytes);
  void(__stdcall *CopyTextureRegion)(ID3D12GraphicsCommandList *self,
                                     ...
                                     const D3D12_BOX *src_box);
  void(__stdcall *CopyResource)(ID3D12GraphicsCommandList *self,
                                ID3D12Resource *dst, ID3D12Resource *src);
  void(__stdcall *CopyTiles)(
      ID3D12GraphicsCommandList *self, ID3D12Resource *tiled_resource,
  ...
  void(__stdcall *ResolveSubresource)(ID3D12GraphicsCommandList *self,
  ...
  void(__stdcall *RSSetViewports)(ID3D12GraphicsCommandList *self,
                                  u32 num_viewports,
                                  const D3D12_VIEWPORT *viewports);
  void(__stdcall *RSSetScissorRects)(ID3D12GraphicsCommandList *self,
                                     u32 num_rects, const D3D12_RECT *rects);
  void(__stdcall *OMSetBlendFactor)(ID3D12GraphicsCommandList *self,
                                    const f32 blend_factor[4]);
  void(__stdcall *OMSetStencilRef)(ID3D12GraphicsCommandList *self,
                                   u32 stencil_ref);
  void(__stdcall *SetPipelineState)(ID3D12GraphicsCommandList *self,
                                    ID3D12PipelineState *pipeline_state);
  void(__stdcall *ResourceBarrier)(ID3D12GraphicsCommandList *self,
                                   u32 num_barriers,
                                   const D3D12_RESOURCE_BARRIER *barriers);
  void(__stdcall *ExecuteBundle)(ID3D12GraphicsCommandList *self,
                                 ID3D12GraphicsCommandList *command_list);
  void(__stdcall *SetDescriptorHeaps)(ID3D12GraphicsCommandList *self,
                                      u32 num_heaps,
                                      ID3D12DescriptorHeap *const *heaps);
  void(__stdcall *SetComputeRootSignature)(ID3D12GraphicsCommandList *self,
                                           ID3D12RootSignature *root_signature);
  void(__stdcall *SetGraphicsRootSignature)(
      ID3D12GraphicsCommandList *self, ID3D12RootSignature *root_signature);
  void(__stdcall *SetComputeRootDescriptorTable)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      D3D12_GPU_DESCRIPTOR_HANDLE base_descriptor);
  void(__stdcall *SetGraphicsRootDescriptorTable)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      D3D12_GPU_DESCRIPTOR_HANDLE base_descriptor);
  ...
  void(__stdcall *SetGraphicsRoot32BitConstant)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index, u32 src_data,
      u32 dest_offset_in_32bit_values);
  void(__stdcall *SetComputeRoot32BitConstants)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      u32 num_32bit_values_to_set, const void *src_data,
      u32 dest_offset_in_32bit_values);
  void(__stdcall *SetGraphicsRoot32BitConstants)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      u32 num_32bit_values_to_set, const void *src_data,
      u32 dest_offset_in_32bit_values);
  void(__stdcall *SetComputeRootConstantBufferView)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      D3D12_GPU_VIRTUAL_ADDRESS buffer_location);
  void(__stdcall *SetGraphicsRootConstantBufferView)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      D3D12_GPU_VIRTUAL_ADDRESS buffer_location);
  void(__stdcall *SetComputeRootShaderResourceView)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      D3D12_GPU_VIRTUAL_ADDRESS buffer_location);
  void(__stdcall *SetGraphicsRootShaderResourceView)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      D3D12_GPU_VIRTUAL_ADDRESS buffer_location);
  void(__stdcall *SetComputeRootUnorderedAccessView)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      D3D12_GPU_VIRTUAL_ADDRESS buffer_location);
  void(__stdcall *SetGraphicsRootUnorderedAccessView)(
      ID3D12GraphicsCommandList *self, u32 root_parameter_index,
      D3D12_GPU_VIRTUAL_ADDRESS buffer_location);
  void(__stdcall *IASetIndexBuffer)(ID3D12GraphicsCommandList *self,
                                    const D3D12_INDEX_BUFFER_VIEW *view);
  void(__stdcall *IASetVertexBuffers)(ID3D12GraphicsCommandList *self,
                                      u32 start_slot, u32 num_views,
                                      const D3D12_VERTEX_BUFFER_VIEW *views);
  void(__stdcall *SOSetTargets)(ID3D12GraphicsCommandList *self, u32 start_slot,
                                u32 num_views,
                                const D3D12_STREAM_OUTPUT_BUFFER_VIEW *views);
  void(__stdcall *OMSetRenderTargets)(
      ID3D12GraphicsCommandList *self, u32 num_render_target_descriptors,
  ...
  void(__stdcall *ClearDepthStencilView)(
      ...
      D3D12_CLEAR_FLAGS clear_flags, f32 depth, u8 stencil, u32 num_rects,
      const D3D12_RECT *rects);
  void(__stdcall *ClearRenderTargetView)(
      ID3D12GraphicsCommandList *self,
      D3D12_CPU_DESCRIPTOR_HANDLE render_target_view, const f32 color_rgba[4],
      u32 num_rects, const D3D12_RECT *rects);
  void(__stdcall *ClearUnorderedAccessViewUint)(
      ...
      const u32 values[4], u32 num_rects, const D3D12_RECT *rects);
  void(__stdcall *ClearUnorderedAccessViewFloat)(
      ID3D12GraphicsCommandList *self,
      D3D12_GPU_DESCRIPTOR_HANDLE view_gpu_handle_in_current_heap,
      D3D12_CPU_DESCRIPTOR_HANDLE view_cpu_handle, ID3D12Resource *resource,
      const f32 values[4], u32 num_rects, const D3D12_RECT *rects);
  void(__stdcall *DiscardResource)(ID3D12GraphicsCommandList *self,
                                   ID3D12Resource *resource,
                                   const D3D12_DISCARD_REGION *region);
  void(__stdcall *BeginQuery)(ID3D12GraphicsCommandList *self,
                              ID3D12QueryHeap *query_heap,
                              D3D12_QUERY_TYPE type, u32 index);
  void(__stdcall *EndQuery)(ID3D12GraphicsCommandList *self,
                            ID3D12QueryHeap *query_heap, D3D12_QUERY_TYPE type,
                            u32 index);
  void(__stdcall *ResolveQueryData)(ID3D12GraphicsCommandList *self,
                                    ID3D12QueryHeap *query_heap,
                                    D3D12_QUERY_TYPE type, u32 start_index,
                                    u32 num_queries,
                                    ID3D12Resource *destination_buffer,
                                    u64 aligned_destination_buffer_offset);
  void(__stdcall *SetPredication)(ID3D12GraphicsCommandList *self,
                                  ID3D12Resource *buffer,
                                  u64 aligned_buffer_offset,
                                  D3D12_PREDICATION_OP operation);
  void(__stdcall *SetMarker)(ID3D12GraphicsCommandList *self, u32 metadata,
                             const void *data, u32 size);
  void(__stdcall *BeginEvent)(ID3D12GraphicsCommandList *self, u32 metadata,
                              const void *data, u32 size);
...
#define ID3D12GraphicsCommandList_QueryInterface(self, ...)                    \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_AddRef(self, ...)                            \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_Release(self, ...)                           \
  ((self)->vtbl->Release(self, __VA_ARGS__))
...
#define ID3D12GraphicsCommandList_SetPrivateDataInterface(self, ...)           \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetName(self, ...)                           \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_GetDevice(self, ...)                         \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_GetType(self, ...)                           \
  ((self)->vtbl->GetType(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_Close(self, ...)                             \
  ((self)->vtbl->Close(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_Reset(self, ...)                             \
  ((self)->vtbl->Reset(self, __VA_ARGS__))
...
#define ID3D12GraphicsCommandList_Dispatch(self, ...)                          \
  ((self)->vtbl->Dispatch(self, __VA_ARGS__))
...
#define ID3D12GraphicsCommandList_CopyTiles(self, ...)                         \
  ((self)->vtbl->CopyTiles(self, __VA_ARGS__))
...
#define ID3D12GraphicsCommandList_EndQuery(self, ...)                          \
  ((self)->vtbl->EndQuery(self, __VA_ARGS__))
...
#define ID3D12GraphicsCommandList_SetMarker(self, ...)                         \
  ((self)->vtbl->SetMarker(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_BeginEvent(self, ...)                        \
  ((self)->vtbl->BeginEvent(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_EndEvent(self, ...)                          \
  ((self)->vtbl->EndEvent(self, __VA_ARGS__))
...
typedef struct ID3D12CommandQueue_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12CommandQueue *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12CommandQueue *self);
  u32(__stdcall *Release)(ID3D12CommandQueue *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12CommandQueue *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12CommandQueue *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(ID3D12CommandQueue *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *SetName)(ID3D12CommandQueue *self, const u16 *name);
  // ID3D12DeviceChild
  i32(__stdcall *GetDevice)(ID3D12CommandQueue *self, const GUID *guid,
                            void **out_device);
  // ID3D12Pageable
  // ID3D12CommandQueue
  void(__stdcall *UpdateTileMappings)(
      ID3D12CommandQueue *self, ID3D12Resource *resource,
      ...
      u32 num_ranges, const D3D12_TILE_RANGE_FLAGS *range_flags,
      const u32 *heap_range_start_offsets, const u32 *range_tile_counts,
  ...
  void(__stdcall *CopyTileMappings)(
      ...
      D3D12_TILE_MAPPING_FLAGS flags);
  void(__stdcall *ExecuteCommandLists)(ID3D12CommandQueue *self,
                                       u32 num_command_lists,
                                       ID3D12CommandList *const *command_lists);
  void(__stdcall *SetMarker)(ID3D12CommandQueue *self, u32 metadata,
                             const void *data, u32 size);
  void(__stdcall *BeginEvent)(ID3D12CommandQueue *self, u32 metadata,
                              const void *data, u32 size);
  void(__stdcall *EndEvent)(ID3D12CommandQueue *self);
  i32(__stdcall *Signal)(ID3D12CommandQueue *self, ID3D12Fence *fence,
                         u64 value);
  i32(__stdcall *Wait)(ID3D12CommandQueue *self, ID3D12Fence *fence, u64 value);
  i32(__stdcall *GetTimestampFrequency)(ID3D12CommandQueue *self,
                                        u64 *out_frequency);
  i32(__stdcall *GetClockCalibration)(ID3D12CommandQueue *self,
                                      u64 *out_gpu_timestamp,
                                      u64 *out_cpu_timestamp);
  D3D12_COMMAND_QUEUE_DESC *(__stdcall *GetDesc)(
      ID3D12CommandQueue *self, D3D12_COMMAND_QUEUE_DESC *out_desc);
...
#define ID3D12CommandQueue_QueryInterface(self, ...)                           \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12CommandQueue_AddRef(self, ...)                                   \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12CommandQueue_Release(self, ...)                                  \
  ((self)->vtbl->Release(self, __VA_ARGS__))
...
#define ID3D12CommandQueue_SetPrivateDataInterface(self, ...)                  \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12CommandQueue_SetName(self, ...)                                  \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12CommandQueue_GetDevice(self, ...)                                \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
...
#define ID3D12CommandQueue_SetMarker(self, ...)                                \
  ((self)->vtbl->SetMarker(self, __VA_ARGS__))
#define ID3D12CommandQueue_BeginEvent(self, ...)                               \
  ((self)->vtbl->BeginEvent(self, __VA_ARGS__))
#define ID3D12CommandQueue_EndEvent(self, ...)                                 \
  ((self)->vtbl->EndEvent(self, __VA_ARGS__))
#define ID3D12CommandQueue_Signal(self, ...)                                   \
  ((self)->vtbl->Signal(self, __VA_ARGS__))
#define ID3D12CommandQueue_Wait(self, ...)                                     \
  ((self)->vtbl->Wait(self, __VA_ARGS__))
...
#define ID3D12CommandQueue_GetDesc(self, ...)                                  \
  ((self)->vtbl->GetDesc(self, __VA_ARGS__))

// ID3D12Device
typedef struct ID3D12Device_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12Device *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(ID3D12Device *self);
  u32(__stdcall *Release)(ID3D12Device *self);
  // ID3D12Object
  i32(__stdcall *GetPrivateData)(ID3D12Device *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *SetPrivateData)(ID3D12Device *self, const GUID *guid,
                                 u32 data_size, const void *data);
  ...
  i32(__stdcall *CreateCommandQueue)(ID3D12Device *self,
                                     const D3D12_COMMAND_QUEUE_DESC *desc,
                                     const GUID *guid,
                                     void **out_command_queue);
  i32(__stdcall *CreateCommandAllocator)(ID3D12Device *self,
                                         D3D12_COMMAND_LIST_TYPE type,
                                         const GUID *guid,
                                         void **out_command_allocator);
  i32(__stdcall *CreateGraphicsPipelineState)(
      ID3D12Device *self, const D3D12_GRAPHICS_PIPELINE_STATE_DESC *desc,
      const GUID *guid, void **out_pipeline_state);
  i32(__stdcall *CreateComputePipelineState)(
      ID3D12Device *self, const D3D12_COMPUTE_PIPELINE_STATE_DESC *desc,
      const GUID *guid, void **out_pipeline_state);
  i32(__stdcall *CreateCommandList)(ID3D12Device *self, u32 node_mask,
                                    D3D12_COMMAND_LIST_TYPE type,
                                    ID3D12CommandAllocator *command_allocator,
                                    ID3D12PipelineState *initial_state,
                                    const GUID *guid, void **out_command_list);
  ...
  i32(__stdcall *CreateDescriptorHeap)(ID3D12Device *self,
                                       const D3D12_DESCRIPTOR_HEAP_DESC *desc,
                                       const GUID *guid, void **out_heap);
  u32(__stdcall *GetDescriptorHandleIncrementSize)(
      ID3D12Device *self, D3D12_DESCRIPTOR_HEAP_TYPE type);
  ...
  void(__stdcall *CreateConstantBufferView)(
      ID3D12Device *self, const D3D12_CONSTANT_BUFFER_VIEW_DESC *desc,
      D3D12_CPU_DESCRIPTOR_HANDLE dest_descriptor);
  void(__stdcall *CreateShaderResourceView)(
      ID3D12Device *self, ID3D12Resource *resource,
      const D3D12_SHADER_RESOURCE_VIEW_DESC *desc,
      D3D12_CPU_DESCRIPTOR_HANDLE dest_descriptor);
  void(__stdcall *CreateUnorderedAccessView)(
      ID3D12Device *self, ID3D12Resource *resource,
      ID3D12Resource *counter_resource,
      const D3D12_UNORDERED_ACCESS_VIEW_DESC *desc,
      D3D12_CPU_DESCRIPTOR_HANDLE dest_descriptor);
  void(__stdcall *CreateRenderTargetView)(
      ID3D12Device *self, ID3D12Resource *resource,
      const D3D12_RENDER_TARGET_VIEW_DESC *desc,
      D3D12_CPU_DESCRIPTOR_HANDLE dest_descriptor);
  void(__stdcall *CreateDepthStencilView)(
      ID3D12Device *self, ID3D12Resource *resource,
      const D3D12_DEPTH_STENCIL_VIEW_DESC *desc,
      D3D12_CPU_DESCRIPTOR_HANDLE dest_descriptor);
  void(__stdcall *CreateSampler)(ID3D12Device *self,
                                 const D3D12_SAMPLER_DESC *desc,
                                 D3D12_CPU_DESCRIPTOR_HANDLE dest_descriptor);
  void(__stdcall *CopyDescriptors)(
      ID3D12Device *self, u32 num_dest_descriptor_ranges,
      const D3D12_CPU_DESCRIPTOR_HANDLE *dest_descriptor_range_starts,
      const u32 *dest_descriptor_range_sizes, u32 num_src_descriptor_ranges,
  ...
  void(__stdcall *CopyDescriptorsSimple)(
      ID3D12Device *self, u32 num_descriptors,
  ...
  i32(__stdcall *CreateCommittedResource)(
      ...
      const D3D12_CLEAR_VALUE *optimized_clear_value, const GUID *guid,
      void **out_resource);
  i32(__stdcall *CreateHeap)(ID3D12Device *self, const D3D12_HEAP_DESC *desc,
                             const GUID *guid, void **out_heap);
  i32(__stdcall *CreatePlacedResource)(
      ID3D12Device *self, ID3D12Heap *heap, u64 heap_offset,
      const D3D12_RESOURCE_DESC *desc,
      D3D12_RESOURCE_STATES initial_resource_state,
      const D3D12_CLEAR_VALUE *optimized_clear_value, const GUID *guid,
      void **out_resource);
  i32(__stdcall *CreateReservedResource)(
      ID3D12Device *self, const D3D12_RESOURCE_DESC *desc,
      D3D12_RESOURCE_STATES initial_resource_state,
      const D3D12_CLEAR_VALUE *optimized_clear_value, const GUID *guid,
      void **out_resource);
  i32(__stdcall *CreateSharedHandle)(ID3D12Device *self,
                                     ID3D12DeviceChild *object,
                                     const SECURITY_ATTRIBUTES *attributes,
                                     u32 access, u16 *name, void **out_handle);
  i32(__stdcall *OpenSharedHandle)(ID3D12Device *self, void *nt_handle,
                                   const GUID *guid, void **out_object);
  i32(__stdcall *OpenSharedHandleByName)(ID3D12Device *self, u16 *name,
                                         u32 access, void **out_nt_handle);
  i32(__stdcall *MakeResident)(ID3D12Device *self, u32 num_objects,
                               ID3D12Pageable *const *objects);
  i32(__stdcall *Evict)(ID3D12Device *self, u32 num_objects,
                        ID3D12Pageable *const *objects);
  i32(__stdcall *CreateFence)(ID3D12Device *self, u64 initial_value,
                              D3D12_FENCE_FLAGS flags, const GUID *guid,
                              void **out_fence);
  i32(__stdcall *GetDeviceRemovedReason)(ID3D12Device *self);
  void(__stdcall *GetCopyableFootprints)(
      ID3D12Device *self, const D3D12_RESOURCE_DESC *desc,
      u32 first_subresource, u32 num_subresources, u64 base_offset,
      D3D12_PLACED_SUBRESOURCE_FOOTPRINT *out_layouts, u32 *out_num_rows,
      u64 *out_row_size_in_bytes, u64 *out_total_bytes);
  i32(__stdcall *CreateQueryHeap)(ID3D12Device *self,
                                  const D3D12_QUERY_HEAP_DESC *desc,
                                  const GUID *guid, void **out_heap);
  i32(__stdcall *SetStablePowerState)(ID3D12Device *self, i32 enable);
  i32(__stdcall *CreateCommandSignature)(
      ID3D12Device *self, const D3D12_COMMAND_SIGNATURE_DESC *desc,
      ID3D12RootSignature *root_signature, const GUID *guid,
      void **out_command_signature);
  void(__stdcall *GetResourceTiling)(
      ID3D12Device *self, ID3D12Resource *tiled_resource,
...
#define ID3D12Device_QueryInterface(self, ...)                                 \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12Device_AddRef(self, ...) ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12Device_Release(self, ...)                                        \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define ID3D12Device_GetPrivateData(self, ...)                                 \
  ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12Device_SetPrivateData(self, ...)                                 \
  ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12Device_SetPrivateDataInterface(self, ...)                        \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define ID3D12Device_SetName(self, ...)                                        \
  ((self)->vtbl->SetName(self, __VA_ARGS__))
#define ID3D12Device_GetNodeCount(self, ...)                                   \
  ((self)->vtbl->GetNodeCount(self, __VA_ARGS__))
...
#define ID3D12Device_CreateSampler(self, ...)                                  \
  ((self)->vtbl->CreateSampler(self, __VA_ARGS__))
#define ID3D12Device_CopyDescriptors(self, ...)                                \
  ((self)->vtbl->CopyDescriptors(self, __VA_ARGS__))
...
#define ID3D12Device_CreateHeap(self, ...)                                     \
  ((self)->vtbl->CreateHeap(self, __VA_ARGS__))
...
#define ID3D12Device_OpenSharedHandle(self, ...)                               \
  ((self)->vtbl->OpenSharedHandle(self, __VA_ARGS__))
#define ID3D12Device_OpenSharedHandleByName(self, ...)                         \
  ((self)->vtbl->OpenSharedHandleByName(self, __VA_ARGS__))
#define ID3D12Device_MakeResident(self, ...)                                   \
  ((self)->vtbl->MakeResident(self, __VA_ARGS__))
#define ID3D12Device_Evict(self, ...) ((self)->vtbl->Evict(self, __VA_ARGS__))
#define ID3D12Device_CreateFence(self, ...)                                    \
  ((self)->vtbl->CreateFence(self, __VA_ARGS__))
...
#define ID3D12Device_CreateQueryHeap(self, ...)                                \
  ((self)->vtbl->CreateQueryHeap(self, __VA_ARGS__))
...
#define ID3D12Device_GetAdapterLuid(self, ...)                                 \
  ((self)->vtbl->GetAdapterLuid(self, __VA_ARGS__))

// ID3D12Debug
typedef struct ID3D12Debug_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12Debug *self, const GUID *guid,
                                 void **out_object);
...
#define ID3D12Debug_QueryInterface(self, ...)                                  \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12Debug_AddRef(self, ...) ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12Debug_Release(self, ...)                                         \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define ID3D12Debug_EnableDebugLayer(self, ...)                                \
  ((self)->vtbl->EnableDebugLayer(self, __VA_ARGS__))

// ID3D12Debug1
typedef struct ID3D12Debug1_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(ID3D12Debug1 *self, const GUID *guid,
                                 void **out_object);
  ...
  void(__stdcall *SetEnableSynchronizedCommandQueueValidation)(
      ID3D12Debug1 *self, i32 enable);
} ID3D12Debug1_vtable;
...
#define ID3D12Debug1_QueryInterface(self, ...)                                 \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define ID3D12Debug1_AddRef(self, ...) ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define ID3D12Debug1_Release(self, ...)                                        \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define ID3D12Debug1_EnableDebugLayer(self, ...)                               \
  ((self)->vtbl->EnableDebugLayer(self, __VA_ARGS__))
...
typedef struct IDXGISwapChain_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(IDXGISwapChain *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(IDXGISwapChain *self);
  u32(__stdcall *Release)(IDXGISwapChain *self);
  // IDXGIObject
  i32(__stdcall *SetPrivateData)(IDXGISwapChain *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(IDXGISwapChain *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *GetPrivateData)(IDXGISwapChain *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *GetParent)(IDXGISwapChain *self, const GUID *guid,
                            void **out_parent);
  // IDXGIDeviceSubObject
  i32(__stdcall *GetDevice)(IDXGISwapChain *self, const GUID *guid,
                            void **out_device);
  // IDXGISwapChain
  i32(__stdcall *Present)(IDXGISwapChain *self, u32 sync_interval, u32 flags);
  i32(__stdcall *GetBuffer)(IDXGISwapChain *self, u32 buffer, const GUID *guid,
                            void **out_surface);
  i32(__stdcall *SetFullscreenState)(IDXGISwapChain *self, i32 fullscreen,
                                     IDXGIOutput *target);
  ...
  i32(__stdcall *ResizeBuffers)(IDXGISwapChain *self, u32 buffer_count,
                                u32 width, u32 height, DXGI_FORMAT new_format,
                                u32 swap_chain_flags);
  i32(__stdcall *ResizeTarget)(IDXGISwapChain *self,
                               const DXGI_MODE_DESC *new_target_parameters);
  i32(__stdcall *GetContainingOutput)(IDXGISwapChain *self,
                                      IDXGIOutput **out_output);
  i32(__stdcall *GetFrameStatistics)(IDXGISwapChain *self,
                                     DXGI_FRAME_STATISTICS *out_stats);
  i32(__stdcall *GetLastPresentCount)(IDXGISwapChain *self,
                                      u32 *out_last_present_count);
...
#define IDXGISwapChain_QueryInterface(self, ...)                               \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define IDXGISwapChain_AddRef(self, ...)                                       \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define IDXGISwapChain_Release(self, ...)                                      \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define IDXGISwapChain_SetPrivateData(self, ...)                               \
  ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define IDXGISwapChain_SetPrivateDataInterface(self, ...)                      \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define IDXGISwapChain_GetPrivateData(self, ...)                               \
  ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define IDXGISwapChain_GetParent(self, ...)                                    \
  ((self)->vtbl->GetParent(self, __VA_ARGS__))
#define IDXGISwapChain_GetDevice(self, ...)                                    \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
#define IDXGISwapChain_Present(self, ...)                                      \
  ((self)->vtbl->Present(self, __VA_ARGS__))
#define IDXGISwapChain_GetBuffer(self, ...)                                    \
  ((self)->vtbl->GetBuffer(self, __VA_ARGS__))
...
#define IDXGISwapChain_GetDesc(self, ...)                                      \
  ((self)->vtbl->GetDesc(self, __VA_ARGS__))
#define IDXGISwapChain_ResizeBuffers(self, ...)                                \
  ((self)->vtbl->ResizeBuffers(self, __VA_ARGS__))
#define IDXGISwapChain_ResizeTarget(self, ...)                                 \
  ((self)->vtbl->ResizeTarget(self, __VA_ARGS__))
...
typedef struct IDXGISwapChain3_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(IDXGISwapChain3 *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(IDXGISwapChain3 *self);
  u32(__stdcall *Release)(IDXGISwapChain3 *self);
  // IDXGIObject
  i32(__stdcall *SetPrivateData)(IDXGISwapChain3 *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(IDXGISwapChain3 *self,
                                          const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *GetPrivateData)(IDXGISwapChain3 *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *GetParent)(IDXGISwapChain3 *self, const GUID *guid,
                            void **out_parent);
  // IDXGIDeviceSubObject
  i32(__stdcall *GetDevice)(IDXGISwapChain3 *self, const GUID *guid,
                            void **out_device);
  // IDXGISwapChain
  ...
  i32(__stdcall *GetBuffer)(IDXGISwapChain3 *self, u32 buffer, const GUID *guid,
                            void **out_surface);
  i32(__stdcall *SetFullscreenState)(IDXGISwapChain3 *self, i32 fullscreen,
                                     IDXGIOutput *target);
  i32(__stdcall *GetFullscreenState)(IDXGISwapChain3 *self, i32 *out_fullscreen,
                                     IDXGIOutput **out_target);
  i32(__stdcall *GetDesc)(IDXGISwapChain3 *self,
                          DXGI_SWAP_CHAIN_DESC *out_desc);
  i32(__stdcall *ResizeBuffers)(IDXGISwapChain3 *self, u32 buffer_count,
                                u32 width, u32 height, DXGI_FORMAT new_format,
                                u32 swap_chain_flags);
  i32(__stdcall *ResizeTarget)(IDXGISwapChain3 *self,
                               const DXGI_MODE_DESC *new_target_parameters);
  i32(__stdcall *GetContainingOutput)(IDXGISwapChain3 *self,
                                      IDXGIOutput **out_output);
  i32(__stdcall *GetFrameStatistics)(IDXGISwapChain3 *self,
                                     DXGI_FRAME_STATISTICS *out_stats);
  i32(__stdcall *GetLastPresentCount)(IDXGISwapChain3 *self,
                                      u32 *out_last_present_count);
  // IDXGISwapChain2
  i32(__stdcall *GetDesc1)(IDXGISwapChain3 *self,
                           DXGI_SWAP_CHAIN_DESC1 *out_desc);
  ...
  i32(__stdcall *GetCoreWindow)(IDXGISwapChain3 *self, const GUID *guid,
                                void **out_window);
  ...
  i32(__stdcall *GetRestrictToOutput)(IDXGISwapChain3 *self,
                                      IDXGIOutput **out_restrict_to_output);
  i32(__stdcall *SetBackgroundColor)(IDXGISwapChain3 *self,
                                     const DXGI_RGBA *color);
  i32(__stdcall *GetBackgroundColor)(IDXGISwapChain3 *self,
                                     DXGI_RGBA *out_color);
  i32(__stdcall *SetRotation)(IDXGISwapChain3 *self,
                              DXGI_MODE_ROTATION rotation);
  i32(__stdcall *GetRotation)(IDXGISwapChain3 *self,
                              DXGI_MODE_ROTATION *out_rotation);
  i32(__stdcall *SetSourceSize)(IDXGISwapChain3 *self, u32 width, u32 height);
  i32(__stdcall *GetSourceSize)(IDXGISwapChain3 *self, u32 *out_width,
                                u32 *out_height);
  i32(__stdcall *SetMaximumFrameLatency)(IDXGISwapChain3 *self,
                                         u32 max_latency);
  i32(__stdcall *GetMaximumFrameLatency)(IDXGISwapChain3 *self,
                                         u32 *out_max_latency);
  void *(__stdcall *GetFrameLatencyWaitableObject)(IDXGISwapChain3 *self);
  i32(__stdcall *SetMatrixTransform)(IDXGISwapChain3 *self,
                                     const DXGI_MATRIX_3X2_F *matrix);
  i32(__stdcall *GetMatrixTransform)(IDXGISwapChain3 *self,
                                     DXGI_MATRIX_3X2_F *out_matrix);
  // IDXGISwapChain3
  u32(__stdcall *GetCurrentBackBufferIndex)(IDXGISwapChain3 *self);
  i32(__stdcall *CheckColorSpaceSupport)(IDXGISwapChain3 *self,
                                         DXGI_COLOR_SPACE_TYPE color_space,
                                         u32 *out_support);
  i32(__stdcall *SetColorSpace1)(IDXGISwapChain3 *self,
                                 DXGI_COLOR_SPACE_TYPE color_space);
  i32(__stdcall *ResizeBuffers1)(IDXGISwapChain3 *self, u32 buffer_count,
...
#define IDXGISwapChain3_QueryInterface(self, ...)                              \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define IDXGISwapChain3_AddRef(self, ...)                                      \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define IDXGISwapChain3_Release(self, ...)                                     \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define IDXGISwapChain3_SetPrivateData(self, ...)                              \
  ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define IDXGISwapChain3_SetPrivateDataInterface(self, ...)                     \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define IDXGISwapChain3_GetPrivateData(self, ...)                              \
  ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define IDXGISwapChain3_GetParent(self, ...)                                   \
  ((self)->vtbl->GetParent(self, __VA_ARGS__))
#define IDXGISwapChain3_GetDevice(self, ...)                                   \
  ((self)->vtbl->GetDevice(self, __VA_ARGS__))
#define IDXGISwapChain3_Present(self, ...)                                     \
  ((self)->vtbl->Present(self, __VA_ARGS__))
#define IDXGISwapChain3_GetBuffer(self, ...)                                   \
  ((self)->vtbl->GetBuffer(self, __VA_ARGS__))
#define IDXGISwapChain3_SetFullscreenState(self, ...)                          \
  ((self)->vtbl->SetFullscreenState(self, __VA_ARGS__))
#define IDXGISwapChain3_GetFullscreenState(self, ...)                          \
  ((self)->vtbl->GetFullscreenState(self, __VA_ARGS__))
#define IDXGISwapChain3_GetDesc(self, ...)                                     \
  ((self)->vtbl->GetDesc(self, __VA_ARGS__))
#define IDXGISwapChain3_ResizeBuffers(self, ...)                               \
  ((self)->vtbl->ResizeBuffers(self, __VA_ARGS__))
#define IDXGISwapChain3_ResizeTarget(self, ...)                                \
  ((self)->vtbl->ResizeTarget(self, __VA_ARGS__))
...
#define IDXGISwapChain3_GetLastPresentCount(self, ...)                         \
  ((self)->vtbl->GetLastPresentCount(self, __VA_ARGS__))
#define IDXGISwapChain3_GetDesc1(self, ...)                                    \
  ((self)->vtbl->GetDesc1(self, __VA_ARGS__))
#define IDXGISwapChain3_GetFullscreenDesc(self, ...)                           \
  ((self)->vtbl->GetFullscreenDesc(self, __VA_ARGS__))
#define IDXGISwapChain3_GetHwnd(self, ...)                                     \
  ((self)->vtbl->GetHwnd(self, __VA_ARGS__))
#define IDXGISwapChain3_GetCoreWindow(self, ...)                               \
  ((self)->vtbl->GetCoreWindow(self, __VA_ARGS__))
#define IDXGISwapChain3_Present1(self, ...)                                    \
  ((self)->vtbl->Present1(self, __VA_ARGS__))
...
#define IDXGISwapChain3_SetRotation(self, ...)                                 \
  ((self)->vtbl->SetRotation(self, __VA_ARGS__))
#define IDXGISwapChain3_GetRotation(self, ...)                                 \
  ((self)->vtbl->GetRotation(self, __VA_ARGS__))
#define IDXGISwapChain3_SetSourceSize(self, ...)                               \
  ((self)->vtbl->SetSourceSize(self, __VA_ARGS__))
#define IDXGISwapChain3_GetSourceSize(self, ...)                               \
  ((self)->vtbl->GetSourceSize(self, __VA_ARGS__))
...
#define IDXGISwapChain3_SetColorSpace1(self, ...)                              \
  ((self)->vtbl->SetColorSpace1(self, __VA_ARGS__))
#define IDXGISwapChain3_ResizeBuffers1(self, ...)                              \
  ((self)->vtbl->ResizeBuffers1(self, __VA_ARGS__))

typedef struct IDXGIFactory4_vtable {
  // IUnknown
  i32(__stdcall *QueryInterface)(IDXGIFactory4 *self, const GUID *guid,
                                 void **out_object);
  u32(__stdcall *AddRef)(IDXGIFactory4 *self);
  u32(__stdcall *Release)(IDXGIFactory4 *self);
  // IDXGIObject
  i32(__stdcall *SetPrivateData)(IDXGIFactory4 *self, const GUID *guid,
                                 u32 data_size, const void *data);
  i32(__stdcall *SetPrivateDataInterface)(IDXGIFactory4 *self, const GUID *guid,
                                          const IUnknown *data);
  i32(__stdcall *GetPrivateData)(IDXGIFactory4 *self, const GUID *guid,
                                 u32 *out_data_size, void *out_data);
  i32(__stdcall *GetParent)(IDXGIFactory4 *self, const GUID *guid,
                            void **out_parent);
  // IDXGIFactory
  i32(__stdcall *EnumAdapters)(IDXGIFactory4 *self, u32 adapter,
                               IDXGIAdapter **out_adapter);
  i32(__stdcall *MakeWindowAssociation)(IDXGIFactory4 *self, void *hwnd,
                                        u32 flags);
  i32(__stdcall *GetWindowAssociation)(IDXGIFactory4 *self, void **out_hwnd);
  i32(__stdcall *CreateSwapChain)(IDXGIFactory4 *self, IUnknown *device,
                                  DXGI_SWAP_CHAIN_DESC *desc,
                                  IDXGISwapChain **out_swap_chain);
  i32(__stdcall *CreateSoftwareAdapter)(IDXGIFactory4 *self, void *module,
                                        IDXGIAdapter **out_adapter);
  i32(__stdcall *EnumAdapters1)(IDXGIFactory4 *self, u32 adapter,
  ...
  i32(__stdcall *CreateSwapChainForHwnd)(
      IDXGIFactory4 *self, IUnknown *device, void *hwnd,
      const DXGI_SWAP_CHAIN_DESC1 *desc,
      const DXGI_SWAP_CHAIN_FULLSCREEN_DESC *fullscreen_desc,
      IDXGIOutput *restrict_to_output, IDXGISwapChain1 **out_swap_chain);
  i32(__stdcall *CreateSwapChainForCoreWindow)(
      IDXGIFactory4 *self, IUnknown *device, IUnknown *window,
      const DXGI_SWAP_CHAIN_DESC1 *desc, IDXGIOutput *restrict_to_output,
      IDXGISwapChain1 **out_swap_chain);
  i32(__stdcall *GetSharedResourceAdapterLuid)(IDXGIFactory4 *self,
                                               void *resource, i64 *out_luid);
  i32(__stdcall *RegisterStereoStatusWindow)(IDXGIFactory4 *self, void *hwnd,
                                             u32 msg, u32 *out_cookie);
  i32(__stdcall *RegisterStereoStatusEvent)(IDXGIFactory4 *self, void *event,
                                            u32 *out_cookie);
  void(__stdcall *UnregisterStereoStatus)(IDXGIFactory4 *self, u32 cookie);
  i32(__stdcall *RegisterOcclusionStatusWindow)(IDXGIFactory4 *self, void *hwnd,
                                                u32 msg, u32 *out_cookie);
  i32(__stdcall *RegisterOcclusionStatusEvent)(IDXGIFactory4 *self, void *event,
                                               u32 *out_cookie);
  void(__stdcall *UnregisterOcclusionStatus)(IDXGIFactory4 *self, u32 cookie);
  i32(__stdcall *CreateSwapChainForComposition)(
      IDXGIFactory4 *self, IUnknown *device, const DXGI_SWAP_CHAIN_DESC1 *desc,
      IDXGIOutput *restrict_to_output, IDXGISwapChain1 **out_swap_chain);
  u32(__stdcall *GetCreationFlags)(IDXGIFactory4 *self);
  // IDXGIFactory4
  i32(__stdcall *EnumAdapterByLuid)(IDXGIFactory4 *self, i64 adapter_luid,
                                    const GUID *guid, void **out_adapter);
  i32(__stdcall *EnumWarpAdapter)(IDXGIFactory4 *self, const GUID *guid,
                                  void **out_adapter);
...
#define IDXGIFactory4_QueryInterface(self, ...)                                \
  ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
#define IDXGIFactory4_AddRef(self, ...)                                        \
  ((self)->vtbl->AddRef(self, __VA_ARGS__))
#define IDXGIFactory4_Release(self, ...)                                       \
  ((self)->vtbl->Release(self, __VA_ARGS__))
#define IDXGIFactory4_SetPrivateData(self, ...)                                \
  ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define IDXGIFactory4_SetPrivateDataInterface(self, ...)                       \
  ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
#define IDXGIFactory4_GetPrivateData(self, ...)                                \
  ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define IDXGIFactory4_GetParent(self, ...)                                     \
  ((self)->vtbl->GetParent(self, __VA_ARGS__))
#define IDXGIFactory4_EnumAdapters(self, ...)                                  \
  ((self)->vtbl->EnumAdapters(self, __VA_ARGS__))
...
#define IDXGIFactory4_CreateSwapChain(self, ...)                               \
  ((self)->vtbl->CreateSwapChain(self, __VA_ARGS__))
#define IDXGIFactory4_CreateSoftwareAdapter(self, ...)                         \
  ((self)->vtbl->CreateSoftwareAdapter(self, __VA_ARGS__))
#define IDXGIFactory4_EnumAdapters1(self, ...)                                 \
  ((self)->vtbl->EnumAdapters1(self, __VA_ARGS__))
#define IDXGIFactory4_IsCurrent(self, ...)                                     \
  ((self)->vtbl->IsCurrent(self, __VA_ARGS__))
...
#define IDXGIFactory4_EnumWarpAdapter(self, ...)                               \
  ((self)->vtbl->EnumWarpAdapter(self, __VA_ARGS__))
...
const GUID IID_ID3D12Debug = {0x344488b7,
                              0x6846,
                              0x474b,
...
const GUID IID_ID3D12Fence = {0x0a753dcf,
                              0xc4d8,
                              0x4b91,
