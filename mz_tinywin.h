...
typedef void *(__stdcall *VirtualAlloc_t)(void *address, u64 size, u32 allocation_type,
                                          u32 protect);
...
typedef i32(__stdcall *PeekMessage_t)(MSG *out_msg, void *hwnd, u32 msg_filter_min,
                                      u32 msg_filter_max, u32 remove_msg);
...
typedef void *(__stdcall *CreateWindowEx_t)(u32 exstyle, const char *class_name,
                                            const char *window_name, u32 style, i32 x, i32 y,
                                            i32 width, i32 height, void *parent, void *menu,
