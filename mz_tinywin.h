...
typedef void *(__stdcall *VirtualAlloc_t)(void *address, u64 size, u32 allocation_type, u32 protect);
...
typedef void *(__stdcall *CreateFile_t)(const char *filename, u32 desired_access, u32 shared_mode, SECURITY_ATTRIBUTES *security_attributes, u32 creation_disposition, u32 flags_and_attributes, void *template_file);
typedef i32 (__stdcall *ReadFile_t)(void *handle, void *out_buffer, u32 number_of_bytes_to_read, u32 *out_number_of_bytes_read, void *overlapped);
...
typedef void *(__stdcall *HeapReAlloc_t)(void *heap, u32 flags, void *address, u64 bytes);
typedef void *(__stdcall *GetProcessHeap_t)(void);
typedef void *(__stdcall *CreateEventEx_t)(SECURITY_ATTRIBUTES *event_attributes, const char *name, u32 flags, u32 desired_access);
typedef u32 (__stdcall *WaitForSingleObject_t)(void *handle, u32 milliseconds);

typedef i32 (__stdcall *PeekMessage_t)(MSG *out_msg, void *hwnd, u32 msg_filter_min, u32 msg_filter_max, u32 remove_msg);
typedef i64 (__stdcall *DispatchMessage_t)(const MSG *msg);
typedef void (__stdcall *PostQuitMessage_t)(i32 exit_code);
typedef i64 (__stdcall *DefWindowProc_t)(void *hwnd, u32 msg, u64 wparam, i64 lparam);
typedef void *(__stdcall *LoadCursor_t)(void *instance, const char *cursor_name);
typedef i16 (__stdcall *RegisterClass_t)(const WNDCLASS *winclass);
typedef void *(__stdcall *CreateWindowEx_t)(u32 exstyle, const char *class_name, const char *window_name, u32 style, i32 x, i32 y, i32 width, i32 height, void *parent, void *menu, void *instance, void *param);
...
typedef i32 (__stdcall *MessageBox_t)(void *hwnd, const char *text, const char *caption, u32 type);
...
void mztw_load_api(void)
{
    ...
    QueryPerformanceCounter = (QueryPerformanceCounter_t)GetProcAddress(kernel32_dll, "QueryPerformanceCounter");
    QueryPerformanceFrequency = (QueryPerformanceFrequency_t)GetProcAddress(kernel32_dll, "QueryPerformanceFrequency");
