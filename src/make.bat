...
%HLSL% /D_VS /E vs_main /Fo ..\bin\data\vs_triangle.cso /T vs_5_1 triangle.hlsl & if errorlevel 1 goto :end
%HLSL% /D_PS /E ps_main /Fo ..\bin\data\ps_triangle.cso /T ps_5_1 triangle.hlsl & if errorlevel 1 goto :end

%ASM% /c /nologo /Fo asmlib.obj asmlib.asm

%CC% /Zi %CFLAGS% /MP /Gm- /nologo /WX /W4 /wd4201 /wd4152 /wd4204 /GS- /Gs999999 /Gy /Gw /EHa- ^
    triangle.c windows.c library.c asmlib.obj ^
