#ifndef MZ_CD3D12_INCLUDED_
#define MZ_CD3D12_INCLUDED_
...
typedef i32 (__stdcall *D3D12CreateDevice_t)(IUnknown *adapter, D3D_FEATURE_LEVEL min_feature_level, const GUID *guid, void **out_object);
...
#define ID3D12Object_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12DeviceChild_QueryInterface(self, ...) ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3D12DeviceChild_GetPrivateData(self, ...) ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12DeviceChild_SetPrivateData(self, ...) ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12DeviceChild_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12RootSignature_QueryInterface(self, ...) ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3D12RootSignature_GetPrivateData(self, ...) ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12RootSignature_SetPrivateData(self, ...) ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12RootSignature_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12Pageable_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12Heap_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
typedef struct ID3D12Resource_vtable {
    ...
    D3D12_GPU_VIRTUAL_ADDRESS (__stdcall *GetGPUVirtualAddress)(ID3D12Resource *self);
...
#define ID3D12Resource_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12Resource_GetGPUVirtualAddress(self, ...) ((self)->vtbl->GetGPUVirtualAddress(self, __VA_ARGS__))
#define ID3D12Resource_WriteToSubresource(self, ...) ((self)->vtbl->WriteToSubresource(self, __VA_ARGS__))
#define ID3D12Resource_ReadFromSubresource(self, ...) ((self)->vtbl->ReadFromSubresource(self, __VA_ARGS__))
#define ID3D12Resource_GetHeapProperties(self, ...) ((self)->vtbl->GetHeapProperties(self, __VA_ARGS__))
...
#define ID3D12CommandAllocator_QueryInterface(self, ...) ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3D12CommandAllocator_GetPrivateData(self, ...) ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12CommandAllocator_SetPrivateData(self, ...) ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12CommandAllocator_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12Fence_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12Fence_GetCompletedValue(self, ...) ((self)->vtbl->GetCompletedValue(self, __VA_ARGS__))
#define ID3D12Fence_SetEventOnCompletion(self, ...) ((self)->vtbl->SetEventOnCompletion(self, __VA_ARGS__))
...
#define ID3D12PipelineState_QueryInterface(self, ...) ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3D12PipelineState_GetPrivateData(self, ...) ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12PipelineState_SetPrivateData(self, ...) ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12PipelineState_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12PipelineState_GetCachedBlob(self, ...) ((self)->vtbl->GetCachedBlob(self, __VA_ARGS__))
...
#define ID3D12DescriptorHeap_QueryInterface(self, ...) ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3D12DescriptorHeap_GetPrivateData(self, ...) ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12DescriptorHeap_SetPrivateData(self, ...) ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12DescriptorHeap_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12DescriptorHeap_GetCPUDescriptorHandleForHeapStart(self, ...) ((self)->vtbl->GetCPUDescriptorHandleForHeapStart(self, __VA_ARGS__))
#define ID3D12DescriptorHeap_GetGPUDescriptorHandleForHeapStart(self, ...) ((self)->vtbl->GetGPUDescriptorHandleForHeapStart(self, __VA_ARGS__))
...
#define ID3D12QueryHeap_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12CommandSignature_QueryInterface(self, ...) ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3D12CommandSignature_GetPrivateData(self, ...) ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12CommandSignature_SetPrivateData(self, ...) ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12CommandSignature_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12CommandList_QueryInterface(self, ...) ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3D12CommandList_GetPrivateData(self, ...) ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12CommandList_SetPrivateData(self, ...) ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12CommandList_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12GraphicsCommandList_QueryInterface(self, ...) ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3D12GraphicsCommandList_GetPrivateData(self, ...) ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetPrivateData(self, ...) ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12GraphicsCommandList_ClearState(self, ...) ((self)->vtbl->ClearState(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_DrawInstanced(self, ...) ((self)->vtbl->DrawInstanced(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_DrawIndexedInstanced(self, ...) ((self)->vtbl->DrawIndexedInstanced(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_Dispatch(self, ...) ((self)->vtbl->Dispatch(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_CopyBufferRegion(self, ...) ((self)->vtbl->CopyBufferRegion(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_CopyTextureRegion(self, ...) ((self)->vtbl->CopyTextureRegion(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_CopyResource(self, ...) ((self)->vtbl->CopyResource(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_CopyTiles(self, ...) ((self)->vtbl->CopyTiles(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_ResolveSubresource(self, ...) ((self)->vtbl->ResolveSubresource(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_IASetPrimitiveTopology(self, ...) ((self)->vtbl->IASetPrimitiveTopology(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_RSSetViewports(self, ...) ((self)->vtbl->RSSetViewports(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_RSSetScissorRects(self, ...) ((self)->vtbl->RSSetScissorRects(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_OMSetBlendFactor(self, ...) ((self)->vtbl->OMSetBlendFactor(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_OMSetStencilRef(self, ...) ((self)->vtbl->OMSetStencilRef(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetPipelineState(self, ...) ((self)->vtbl->SetPipelineState(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_ResourceBarrier(self, ...) ((self)->vtbl->ResourceBarrier(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_ExecuteBundle(self, ...) ((self)->vtbl->ExecuteBundle(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetDescriptorHeaps(self, ...) ((self)->vtbl->SetDescriptorHeaps(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetComputeRootSignature(self, ...) ((self)->vtbl->SetComputeRootSignature(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetGraphicsRootSignature(self, ...) ((self)->vtbl->SetGraphicsRootSignature(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetComputeRootDescriptorTable(self, ...) ((self)->vtbl->SetComputeRootDescriptorTable(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetGraphicsRootDescriptorTable(self, ...) ((self)->vtbl->SetGraphicsRootDescriptorTable(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetComputeRoot32BitConstant(self, ...) ((self)->vtbl->SetComputeRoot32BitConstant(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetGraphicsRoot32BitConstant(self, ...) ((self)->vtbl->SetGraphicsRoot32BitConstant(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetComputeRoot32BitConstants(self, ...) ((self)->vtbl->SetComputeRoot32BitConstants(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetGraphicsRoot32BitConstants(self, ...) ((self)->vtbl->SetGraphicsRoot32BitConstants(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetComputeRootConstantBufferView(self, ...) ((self)->vtbl->SetComputeRootConstantBufferView(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetGraphicsRootConstantBufferView(self, ...) ((self)->vtbl->SetGraphicsRootConstantBufferView(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetComputeRootShaderResourceView(self, ...) ((self)->vtbl->SetComputeRootShaderResourceView(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetGraphicsRootShaderResourceView(self, ...) ((self)->vtbl->SetGraphicsRootShaderResourceView(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetComputeRootUnorderedAccessView(self, ...) ((self)->vtbl->SetComputeRootUnorderedAccessView(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetGraphicsRootUnorderedAccessView(self, ...) ((self)->vtbl->SetGraphicsRootUnorderedAccessView(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_IASetIndexBuffer(self, ...) ((self)->vtbl->IASetIndexBuffer(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_IASetVertexBuffers(self, ...) ((self)->vtbl->IASetVertexBuffers(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SOSetTargets(self, ...) ((self)->vtbl->SOSetTargets(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_OMSetRenderTargets(self, ...) ((self)->vtbl->OMSetRenderTargets(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_ClearDepthStencilView(self, ...) ((self)->vtbl->ClearDepthStencilView(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_ClearRenderTargetView(self, ...) ((self)->vtbl->ClearRenderTargetView(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_ClearUnorderedAccessViewUint(self, ...) ((self)->vtbl->ClearUnorderedAccessViewUint(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_ClearUnorderedAccessViewFloat(self, ...) ((self)->vtbl->ClearUnorderedAccessViewFloat(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_DiscardResource(self, ...) ((self)->vtbl->DiscardResource(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_BeginQuery(self, ...) ((self)->vtbl->BeginQuery(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_EndQuery(self, ...) ((self)->vtbl->EndQuery(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_ResolveQueryData(self, ...) ((self)->vtbl->ResolveQueryData(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetPredication(self, ...) ((self)->vtbl->SetPredication(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_SetMarker(self, ...) ((self)->vtbl->SetMarker(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_BeginEvent(self, ...) ((self)->vtbl->BeginEvent(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_EndEvent(self, ...) ((self)->vtbl->EndEvent(self, __VA_ARGS__))
#define ID3D12GraphicsCommandList_ExecuteIndirect(self, ...) ((self)->vtbl->ExecuteIndirect(self, __VA_ARGS__))
...
#define ID3D12CommandQueue_QueryInterface(self, ...) ((self)->vtbl->QueryInterface(self, __VA_ARGS__))
...
#define ID3D12CommandQueue_GetPrivateData(self, ...) ((self)->vtbl->GetPrivateData(self, __VA_ARGS__))
#define ID3D12CommandQueue_SetPrivateData(self, ...) ((self)->vtbl->SetPrivateData(self, __VA_ARGS__))
#define ID3D12CommandQueue_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12CommandQueue_UpdateTileMappings(self, ...) ((self)->vtbl->UpdateTileMappings(self, __VA_ARGS__))
#define ID3D12CommandQueue_CopyTileMappings(self, ...) ((self)->vtbl->CopyTileMappings(self, __VA_ARGS__))
#define ID3D12CommandQueue_ExecuteCommandLists(self, ...) ((self)->vtbl->ExecuteCommandLists(self, __VA_ARGS__))
...
#define ID3D12CommandQueue_GetTimestampFrequency(self, ...) ((self)->vtbl->GetTimestampFrequency(self, __VA_ARGS__))
#define ID3D12CommandQueue_GetClockCalibration(self, ...) ((self)->vtbl->GetClockCalibration(self, __VA_ARGS__))
...
#define ID3D12Device_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define ID3D12Device_CreateCommandQueue(self, ...) ((self)->vtbl->CreateCommandQueue(self, __VA_ARGS__))
#define ID3D12Device_CreateCommandAllocator(self, ...) ((self)->vtbl->CreateCommandAllocator(self, __VA_ARGS__))
#define ID3D12Device_CreateGraphicsPipelineState(self, ...) ((self)->vtbl->CreateGraphicsPipelineState(self, __VA_ARGS__))
#define ID3D12Device_CreateComputePipelineState(self, ...) ((self)->vtbl->CreateComputePipelineState(self, __VA_ARGS__))
#define ID3D12Device_CreateCommandList(self, ...) ((self)->vtbl->CreateCommandList(self, __VA_ARGS__))
#define ID3D12Device_CheckFeatureSupport(self, ...) ((self)->vtbl->CheckFeatureSupport(self, __VA_ARGS__))
#define ID3D12Device_CreateDescriptorHeap(self, ...) ((self)->vtbl->CreateDescriptorHeap(self, __VA_ARGS__))
#define ID3D12Device_GetDescriptorHandleIncrementSize(self, ...) ((self)->vtbl->GetDescriptorHandleIncrementSize(self, __VA_ARGS__))
#define ID3D12Device_CreateRootSignature(self, ...) ((self)->vtbl->CreateRootSignature(self, __VA_ARGS__))
#define ID3D12Device_CreateConstantBufferView(self, ...) ((self)->vtbl->CreateConstantBufferView(self, __VA_ARGS__))
#define ID3D12Device_CreateShaderResourceView(self, ...) ((self)->vtbl->CreateShaderResourceView(self, __VA_ARGS__))
#define ID3D12Device_CreateUnorderedAccessView(self, ...) ((self)->vtbl->CreateUnorderedAccessView(self, __VA_ARGS__))
#define ID3D12Device_CreateRenderTargetView(self, ...) ((self)->vtbl->CreateRenderTargetView(self, __VA_ARGS__))
#define ID3D12Device_CreateDepthStencilView(self, ...) ((self)->vtbl->CreateDepthStencilView(self, __VA_ARGS__))
...
#define ID3D12Device_CopyDescriptorsSimple(self, ...) ((self)->vtbl->CopyDescriptorsSimple(self, __VA_ARGS__))
#define ID3D12Device_GetResourceAllocationInfo(self, ...) ((self)->vtbl->GetResourceAllocationInfo(self, __VA_ARGS__))
#define ID3D12Device_GetCustomHeapProperties(self, ...) ((self)->vtbl->GetCustomHeapProperties(self, __VA_ARGS__))
#define ID3D12Device_CreateCommittedResource(self, ...) ((self)->vtbl->CreateCommittedResource(self, __VA_ARGS__))
#define ID3D12Device_CreateHeap(self, ...) ((self)->vtbl->CreateHeap(self, __VA_ARGS__))
#define ID3D12Device_CreatePlacedResource(self, ...) ((self)->vtbl->CreatePlacedResource(self, __VA_ARGS__))
#define ID3D12Device_CreateReservedResource(self, ...) ((self)->vtbl->CreateReservedResource(self, __VA_ARGS__))
#define ID3D12Device_CreateSharedHandle(self, ...) ((self)->vtbl->CreateSharedHandle(self, __VA_ARGS__))
#define ID3D12Device_OpenSharedHandle(self, ...) ((self)->vtbl->OpenSharedHandle(self, __VA_ARGS__))
#define ID3D12Device_OpenSharedHandleByName(self, ...) ((self)->vtbl->OpenSharedHandleByName(self, __VA_ARGS__))
...
#define ID3D12Device_GetDeviceRemovedReason(self, ...) ((self)->vtbl->GetDeviceRemovedReason(self, __VA_ARGS__))
#define ID3D12Device_GetCopyableFootprints(self, ...) ((self)->vtbl->GetCopyableFootprints(self, __VA_ARGS__))
#define ID3D12Device_CreateQueryHeap(self, ...) ((self)->vtbl->CreateQueryHeap(self, __VA_ARGS__))
#define ID3D12Device_SetStablePowerState(self, ...) ((self)->vtbl->SetStablePowerState(self, __VA_ARGS__))
#define ID3D12Device_CreateCommandSignature(self, ...) ((self)->vtbl->CreateCommandSignature(self, __VA_ARGS__))
#define ID3D12Device_GetResourceTiling(self, ...) ((self)->vtbl->GetResourceTiling(self, __VA_ARGS__))
...
#define IDXGISwapChain_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define IDXGISwapChain_SetFullscreenState(self, ...) ((self)->vtbl->SetFullscreenState(self, __VA_ARGS__))
#define IDXGISwapChain_GetFullscreenState(self, ...) ((self)->vtbl->GetFullscreenState(self, __VA_ARGS__))
...
#define IDXGISwapChain_GetContainingOutput(self, ...) ((self)->vtbl->GetContainingOutput(self, __VA_ARGS__))
#define IDXGISwapChain_GetFrameStatistics(self, ...) ((self)->vtbl->GetFrameStatistics(self, __VA_ARGS__))
#define IDXGISwapChain_GetLastPresentCount(self, ...) ((self)->vtbl->GetLastPresentCount(self, __VA_ARGS__))
...
#define IDXGISwapChain3_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define IDXGISwapChain3_SetFullscreenState(self, ...) ((self)->vtbl->SetFullscreenState(self, __VA_ARGS__))
#define IDXGISwapChain3_GetFullscreenState(self, ...) ((self)->vtbl->GetFullscreenState(self, __VA_ARGS__))
...
#define IDXGISwapChain3_GetContainingOutput(self, ...) ((self)->vtbl->GetContainingOutput(self, __VA_ARGS__))
#define IDXGISwapChain3_GetFrameStatistics(self, ...) ((self)->vtbl->GetFrameStatistics(self, __VA_ARGS__))
#define IDXGISwapChain3_GetLastPresentCount(self, ...) ((self)->vtbl->GetLastPresentCount(self, __VA_ARGS__))
#define IDXGISwapChain3_GetDesc1(self, ...) ((self)->vtbl->GetDesc1(self, __VA_ARGS__))
#define IDXGISwapChain3_GetFullscreenDesc(self, ...) ((self)->vtbl->GetFullscreenDesc(self, __VA_ARGS__))
...
#define IDXGISwapChain3_IsTemporaryMonoSupported(self, ...) ((self)->vtbl->IsTemporaryMonoSupported(self, __VA_ARGS__))
#define IDXGISwapChain3_GetRestrictToOutput(self, ...) ((self)->vtbl->GetRestrictToOutput(self, __VA_ARGS__))
#define IDXGISwapChain3_SetBackgroundColor(self, ...) ((self)->vtbl->SetBackgroundColor(self, __VA_ARGS__))
#define IDXGISwapChain3_GetBackgroundColor(self, ...) ((self)->vtbl->GetBackgroundColor(self, __VA_ARGS__))
...
#define IDXGISwapChain3_SetMaximumFrameLatency(self, ...) ((self)->vtbl->SetMaximumFrameLatency(self, __VA_ARGS__))
#define IDXGISwapChain3_GetMaximumFrameLatency(self, ...) ((self)->vtbl->GetMaximumFrameLatency(self, __VA_ARGS__))
#define IDXGISwapChain3_GetFrameLatencyWaitableObject(self, ...) ((self)->vtbl->GetFrameLatencyWaitableObject(self, __VA_ARGS__))
#define IDXGISwapChain3_SetMatrixTransform(self, ...) ((self)->vtbl->SetMatrixTransform(self, __VA_ARGS__))
#define IDXGISwapChain3_GetMatrixTransform(self, ...) ((self)->vtbl->GetMatrixTransform(self, __VA_ARGS__))
#define IDXGISwapChain3_GetCurrentBackBufferIndex(self, ...) ((self)->vtbl->GetCurrentBackBufferIndex(self, __VA_ARGS__))
#define IDXGISwapChain3_CheckColorSpaceSupport(self, ...) ((self)->vtbl->CheckColorSpaceSupport(self, __VA_ARGS__))
...
#define IDXGIFactory4_SetPrivateDataInterface(self, ...) ((self)->vtbl->SetPrivateDataInterface(self, __VA_ARGS__))
...
#define IDXGIFactory4_MakeWindowAssociation(self, ...) ((self)->vtbl->MakeWindowAssociation(self, __VA_ARGS__))
#define IDXGIFactory4_GetWindowAssociation(self, ...) ((self)->vtbl->GetWindowAssociation(self, __VA_ARGS__))
#define IDXGIFactory4_CreateSwapChain(self, ...) ((self)->vtbl->CreateSwapChain(self, __VA_ARGS__))
#define IDXGIFactory4_CreateSoftwareAdapter(self, ...) ((self)->vtbl->CreateSoftwareAdapter(self, __VA_ARGS__))
...
#define IDXGIFactory4_IsWindowedStereoEnabled(self, ...) ((self)->vtbl->IsWindowedStereoEnabled(self, __VA_ARGS__))
#define IDXGIFactory4_CreateSwapChainForHwnd(self, ...) ((self)->vtbl->CreateSwapChainForHwnd(self, __VA_ARGS__))
#define IDXGIFactory4_CreateSwapChainForCoreWindow(self, ...) ((self)->vtbl->CreateSwapChainForCoreWindow(self, __VA_ARGS__))
#define IDXGIFactory4_GetSharedResourceAdapterLuid(self, ...) ((self)->vtbl->GetSharedResourceAdapterLuid(self, __VA_ARGS__))
#define IDXGIFactory4_RegisterStereoStatusWindow(self, ...) ((self)->vtbl->RegisterStereoStatusWindow(self, __VA_ARGS__))
#define IDXGIFactory4_RegisterStereoStatusEvent(self, ...) ((self)->vtbl->RegisterStereoStatusEvent(self, __VA_ARGS__))
#define IDXGIFactory4_UnregisterStereoStatus(self, ...) ((self)->vtbl->UnregisterStereoStatus(self, __VA_ARGS__))
#define IDXGIFactory4_RegisterOcclusionStatusWindow(self, ...) ((self)->vtbl->RegisterOcclusionStatusWindow(self, __VA_ARGS__))
#define IDXGIFactory4_RegisterOcclusionStatusEvent(self, ...) ((self)->vtbl->RegisterOcclusionStatusEvent(self, __VA_ARGS__))
#define IDXGIFactory4_UnregisterOcclusionStatus(self, ...) ((self)->vtbl->UnregisterOcclusionStatus(self, __VA_ARGS__))
#define IDXGIFactory4_CreateSwapChainForComposition(self, ...) ((self)->vtbl->CreateSwapChainForComposition(self, __VA_ARGS__))
#define IDXGIFactory4_GetCreationFlags(self, ...) ((self)->vtbl->GetCreationFlags(self, __VA_ARGS__))
#define IDXGIFactory4_EnumAdapterByLuid(self, ...) ((self)->vtbl->EnumAdapterByLuid(self, __VA_ARGS__))
...
void mzcd3d12_load_api(void);

#endif // #ifndef MZ_CD3D12_INCLUDED_



#ifdef MZ_CD3D12_IMPLEMENTATION
...
#undef MZ_CD3D12_IMPLEMENTATION
#endif // #ifdef MZ_CD3D12_IMPLEMENTATION
